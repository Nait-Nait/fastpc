    ...
    return (
        <header className="flex flex-row space-x-10 bg-transparent w-full pt-4 mb-10 border-b-2 border-[var(--main)]">
            ...
            <div className="flex md:flex-row flex-col space-y-5 space-x-10 justify-end">
                <Input className="md:w-[300px] md:mx-10 mx-auto" type="text" placeholder="Buscar" />
                <div className="flex flex-row space-x-5">
                    <Button className="bg-[var(--secondary-background)] dark:text-white text-sm">Categorias</Button>
                    <Button className="bg-[var(--secondary-background)] dark:text-white">Componentes</Button>
                    <Button className="bg-[var(--secondary-background)] dark:text-white">Arma tu PC</Button>
                    ...
                    <DropdownMenu>
                        ...
                        <DropdownMenuContent align="start" className="w-56">
                            <DropdownMenuGroup>
                                ...
                                {loading && <DropdownMenuLabel inset>Cargando...</DropdownMenuLabel>}
